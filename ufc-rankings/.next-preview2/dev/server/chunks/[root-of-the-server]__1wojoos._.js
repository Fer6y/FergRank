...
"[project]/src/lib/loadUpcoming.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/advancedStats.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/fighterDisplay.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/fighterAges.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/titleFights.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const FILE = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'data', 'title_fights.csv');
// Same normalization as scripts/buildTitleFights.ts so pair keys line up.
const norm = (s)=>(s || '').normalize('NFKD').replace(/[̀-ͯ]/g, '').toLowerCase().replace(/[^a-z ]/g, '').replace(/\s+/g, ' ').trim();
const pairKey = (a, b)=>[
        norm(a),
        norm(b)
    ].sort().join('|');
...
function load() {
    ...
    const map = new Map();
    index = map;
    if (!__TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].existsSync(FILE)) return map;
    const rows = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$papaparse$2f$papaparse$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].parse(__TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].readFileSync(FILE, 'utf-8'), {
        header: true,
        skipEmptyLines: true
    }).data;
...
function isTitleFight(fighterName, opponentName, isoDate, weightClass) {
...
"[project]/src/lib/fighterPhysical.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const FILE = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'data', 'Fighters.csv');
let reachById = null;
function load() {
...
function getReach(fighterId) {
    return load().get(fighterId) ?? null;
}
}),
"[project]/src/lib/divisions.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/upcomingEnrich.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$eloEngine$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/eloEngine.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$advancedStats$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/advancedStats.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fighterDisplay$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/fighterDisplay.ts [app-route] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fighterAges$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/fighterAges.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$titleFights$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/titleFights.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fighterPhysical$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/fighterPhysical.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$divisions$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/divisions.ts [app-route] (ecmascript)");
...
function formatMethod(method, round) {
    const m = method.trim().toUpperCase();
...
async function enrichCards(cards) {
    ...
    for (const division of __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ALL_DIVISIONS"]){
        ...
        const contenderRank = new Map(rankings.fighters.filter((f)=>!isChampion(f)).map((f, i)=>[
                f.fighterId,
                i + 1
            ]));
    ...
    const enrich = (id, name)=>{
        ...
        const media = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fighterMedia$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getFighterMedia"])(id);
        const info = rankMap.get(id);
        const fighter = data.fighterMap.get(id);
        const history = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$eloEngine$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getFighterHistory"])(data, id);
        // Rank badge.
        let rankLabel = null;
        if (info?.isChampion) rankLabel = 'C';
        else if (info?.displayRank) rankLabel = `#${info.displayRank} ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$divisions$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["shortDivision"])(info.division)}`;
        // Description: style + UFC record (computed from UFC fight history).
        let description = null;
        if (fighter) {
            const style = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fighterDisplay$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["describeStyle"])({
                koRate: fighter.koRate,
                subRate: fighter.subRate,
                sigStrikeAccuracy: fighter.sigStrikeAccuracy,
        ...
        const recentFights = history.slice(0, 5).map((h)=>({
                ...
                isTitle: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$titleFights$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isTitleFight"])(ownName, h.opponentName, h.date, h.weightClass)
            }));
        ...
        const finishRate = info?.finishRate ?? (fighter ? fighter.koRate + fighter.subRate : null);
        return {
            fighterId: id,
            name,
            ...
            age: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fighterAges$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getFighterAge"])(id)?.age ?? null,
            description,
            recentFights,
            reach: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fighterPhysical$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getReach"])(id),
            finishRate,
            scheduleStrength: info?.scheduleStrength ?? null,
            scheduleQuality: info?.scheduleQuality ?? null
        };
    };
    const ratings = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$eloEngine$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["buildEloRatings"])(data);
    const probs = (id1, id2)=>{
        ...
        const eloA = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$eloEngine$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getElo"])(ratings, id1).rating;
        const eloB = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$eloEngine$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getElo"])(ratings, id2).rating;
        const nudgeA = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$advancedStats$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["formEloNudge"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$advancedStats$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAdvancedStats"])(data, id1)?.drift);
        const nudgeB = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$advancedStats$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["formEloNudge"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$advancedStats$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAdvancedStats"])(data, id2)?.drift);
        return {
            prob1: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$eloEngine$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["winProbability"])(eloA, eloB),
            formProb1: nudgeA !== 0 || nudgeB !== 0 ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$eloEngine$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["winProbability"])(eloA + nudgeA, eloB + nudgeB) : null
        };
    };
...
"[project]/src/app/api/upcoming/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$loadUpcoming$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/loadUpcoming.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$upcomingEnrich$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/upcomingEnrich.ts [app-route] (ecmascript)");
;
;
;
const revalidate = 86400; // 24 hours ISR
async function GET() {
    const events = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$upcomingEnrich$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["enrichCards"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$loadUpcoming$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getUpcomingCards"])());
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1wojoos._.js.map